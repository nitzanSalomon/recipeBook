        ...
        content : {
            salads : { // תת נושא
                'ויניגרט-חרדל-ודבש' : {
                    ...
                    preparation : [
                        `לבלנדר את כול המרכיבים ביחד.`,
                        `לאחסן בצנצנת במקרר ולשים כמה כפות על סלט כשרוצים.`,
                    ],
                },
                'סלט-חסה' : {
                    pic: ``,
                    ...
                    ingredients : [
                        ...
                        `1 בצל קצוץ`,
                        `1 תפוח ירוק מגורר`,
                        `אופצינלי: 3 כפות ויניגרט רחדל ודבש`,
                        `אופצינלי: אגוזי מלך קצוצים/ צנוברים קלויים`,
                    ],
                    preparation : [
                        `לערבב את כול המרכיבים בקערה.`,
                    ],
                },
                'סלט-טאבולה' : {
                    pic: `lantelSalad`,
                    description: `מתכון של נאווה ציון`,
                    difficulty: `קל`,
                    quantity: `8 מנות`,
                    time: `12 שעות`,
                    ingredients : [
                        `חצי כוס עדשים ירוקות/ עדשי מש`,
                        `חצי כוס בורגול`,
                        `פלפל אדום קצוץ`,
                        `פלפל צהוב קצוץ`,
                        `2 מלפפונים קצוצים`,
                        `עלה חסה קצוץ`,
                        `בצל ירוק קצוץ - גבעול אחד`,
                        `אגוזי מלך קצוצים - חופן`,
                        `חמוציות - חופן`,
                        `1/2 כוס פטרוזיליה`,
                        `כף שמן זית`,
                        `מעט מלח`,
                    ...
                    preparation : [
                        `להשרות עדשים למשך לילה ובורגול לכמה שעות.`,
                        `לבשל עדשים ולקרר.`,
            ...
            starters : { // תת נושא
                ...
                'גריסיני' : {
                    ...
                    ingredients : [
                        ...
                        `כף מלח`,
                        `2 כוסות מים`,
                        `לציפוי: חלמון אחד להברשה, מלח גס, צ'ילי גרוס, פרזמן.`,
                    ],
                    preparation : [
                        `מערבבים את הקמח, הסוכר, השמרים, האורגנו והחמאה.`,
                        `מוסיפים מים בהדרגה.`,
                        `לשים כ-7 דקות את הבצק.`,
                        `מוסיפים את המלח ולשים עוד 5 דקות.`,
                        `מחלקים את הבצק לכדורים, מגלגלים כול כדור לנקניק ומניחים על תבנית מרופדת נייר אפייה.`,
                        `מורחים את החלמון ומתבלים איך שרוצים (מלח גס, צ'ילי, גבינה או שומשום).`,
                        `אופים ב170° כ-17 דקות עד להזהבה.`,
                    ],
                },
                'לחם-כוסמין' : {
                    pic: ``,
                    ...
                    time: `3 שעות`,
                    ingredients : [
                        `750 גרם קמח כוסמין מלא (או חצי חצי עם כוסמין רגיל)`,
                        `500 מ"ל מים פושרים`,
                        `15 גרם שמרים יבשים`,
                        `20 גרם סוכר`,
                        `כף שמן זית`,
                    ...
                    preparation : [
                        `לשים את כול החומרים במיקסר עם וו לישה במיהירות בינונית ל10-12 דקות.`,
                        `מתפיחים בקערה מכוסה שעה-שעתיים.`,
                        `מחלקים את הבצק לשני חלקים שווים, יוצרים צורת כיכר מכול חלק, מניחים על תבנית עם נייר אפייה ומתפיחים מכוסה עד להכפלת נפח.`,
                        `מחממים תנור ל250°, חורצים את הלחם עם סכין בחלק העליון ומפזרים מעט קמח.`,
                        `אופים 10-12 דקות בחום מקסימלי ואז מנמיכים ל190° וממשיכים לאפות 20-25 דקות, מצננים עד לקירור מוחלט.`,
                        `להקפיא פרוס, ניתן להוסיף אגוזים או גרעינים.`,
                    ],
                },
                'פשטידת-בטטה-ובצל' : {
                    pic: ``,
                    ...
                    time: `50 דקות`,
                    ingredients : [
                        `2 בטטות (לבשל במיקרו, להוציא את הבפנים ולמעוך)`,
                        `בצל גדול קצוץ (לבשל במיקרו/ על מחבת)`,
                    ...
                    preparation : [
                        `מערבבים את כול המרכיבים.`,
                        `יוצקים לתבנית קאפקייק משומנת`,
                        `אופים ב180° כ 30-35 דקות.`,
                    ],
                },
                'דוגמא' : {
                    pic: ``,
